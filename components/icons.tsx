...
export const LoaderIcon: React.FC<IconProps> = ({ className }) => (
  <svg className={className || "h-5 w-5 text-white"} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const UploadIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className || "mx-auto h-8 w-8 text-slate-400"} stroke="currentColor" fill="none" viewBox="0 0 48 48" aria-hidden="true">
        <path d="M28 8H12a4 4 0 00-4 4v20m32-12v8m0 0v8a4 4 0 01-4 4H12a4 4 0 01-4-4v-4m32-4l-3.172-3.172a4 4 0 00-5.656 0L28 28M8 32l9.172-9.172a4 4 0 015.656 0L28 28m0 0l4 4m4-24h8m-4-4v8" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
);

export const FileIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className || "h-5 w-5 text-slate-500 dark:text-slate-400"} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
// FIX: The GlobeIcon component had multiple syntax errors, including unquoted attribute values, which caused a cascade of compilation failures. It has been replaced with a corrected version.
